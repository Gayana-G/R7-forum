class PostsController < ApplicationController
  ...
  def new
    @post = @forums.posts.new
  end

  def edit #nothing here
  end

  def show #nothing here
  end
  ...
  def set_forum
    @forum = Forum.find(params[:forum_id])  # If you check the routes for posts, you see that this is the forum parameter
  end                                         
